...
<body class="">
    ...
    <section class="mt-5">
        ...
        <div class="container my-5 shadow">
            <div class="row">
                <div class="col-2">
                    <img src="assets/img/resume/<?php echo $_SESSION['Picture']; ?>" class="rounded" height="130" width="130" alt="profile pics">
                </div>
                <div class="col-10">
                    <div class="info-sum">
            ...
            <div class="row bg-secondary my-5 p-3">
                <div class="col-6">
                    <div class="info-sum">
                        <p class="text-white"><i class="las la-envelope"></i> <?php echo $_SESSION['email']; ?> </p>
                ...
                <div class="col-6">
                    <div class="info-sum">
                        <p class="text-white"><i class="las la-phone-alt"></i> <?php echo $_SESSION['Phone']; ?> </p>

                        <p class="text-white"><i class="las la-calendar-check"></i> <?php echo $_SESSION['DOB']; ?> </p>
            ...
            <div class="row my-5 p-3">
                <div class="col">
                    ...
                    <div class="ps-4">
                        <p><b> <?php echo $_SESSION['Course']; ?> </b></p>
                        <p> <?php echo $_SESSION['University']; ?> </p>
                        <p><small><i> 10/2015 – 7/2021 </i></small></p>
                    </div>

                    <div class="ps-4 mt-3">
                        <p><b> <?php echo $_SESSION['Certificate']; ?> </b></p>
                        <p> <?php echo $_SESSION['sss']; ?> </p>
